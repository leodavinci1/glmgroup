            ...
            <AboutCol md={6}>
              <Col md={12}>
                <AnimationContainer animation="fadeIn" delay={1500}>
                  <AboutContent>
                    <Heading>
                      Renowned <Color>Software</Color> Company From{" "}
                      <Color>London</Color>
                    </Heading>
                    <Separator />
                    <Text>
                      Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                      In rutrum quis urna a ullamcorper. Integer enim felis,
                      pellentesque ac felis et, varius ornare nisl. Nunc mauris
                      turpis, porttitor sit amet mattis ac, ultricies sit amet
                      diam. Nunc aliquet tincidunt lobortis. Ut quis felis
                      tincidunt, tincidunt ex quis, ultricies nisi. Duis in
                      tortor porta, laoreet erat tristique, ornare augue.
                    </Text>
                  </AboutContent>
                </AnimationContainer>
              </Col>
