...
class TeamItem extends React.Component {
  ...
  showContent() {
    setTimeout(() => {
      this.child.enable();
      document
        .getElementById(`team-item-${this.props.index}`)
  ...
  render() {
    ...
    const MobileContent = styled.div`
            ...
            width: 100%;
            top: 0;
            background-image: linear-gradient(to top, rgb(166, 124, 0), rgba(255, 255, 255, 0));
            opacity: 0 !important;
            transition: .5s;
            display: flex;
    ...
    const Item = styled.div`
      ...
      &.blue-shadow {
        box-shadow: 0 0px 15px rgb(166, 124, 0, 0.2);
        transition: 0.5s;
        &:hover {
          box-shadow: 0 0px 15px rgb(166, 124, 0, 0.5);
        }
      }
    `;
            ...
            <MobileContent>
              <Info>
                ...
                <Social>
                  <FontAwesomeIcon
                    icon={faFacebook}
                    onClick={() => window.open(this.props.facebook)}
                  />
                  <FontAwesomeIcon
                    icon={faTwitter}
                    onClick={() => window.open(this.props.twitter)}
                  />
                  <FontAwesomeIcon
                    icon={faLinkedin}
